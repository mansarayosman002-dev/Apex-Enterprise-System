        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          {payrollRecords.some((r) => r.status !== 'Approved' && r.status !== 'Paid') && (
            <button
              ...
              className="flex items-center space-x-1.5 rounded-xl border border-emerald-300 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-950/60 px-3.5 py-2 text-xs font-semibold text-emerald-800 dark:text-emerald-300 hover:bg-emerald-100 dark:hover:bg-emerald-900/60 transition disabled:opacity-50"
            >
          ...
          >
            ...
            <span>Preview & Calculate Payroll</span>
          </button>
        </div>
      </div>
